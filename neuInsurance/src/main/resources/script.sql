...
-- 2. 管理员数据（密码是123456的MD5：e10adc3949ba59abbe56e057f20f883e）
...
('admin', 'admin', '超级管理员', 'admin@insurance.gov.cn', '13800000000', 'admin', 'SUPER_ADMIN', '系统管理部', '系统管理员', '男', '系统管理员', 1, 2, 'system', '系统默认管理员'),
('manager', 'manager', '业务管理员', 'manager@insurance.gov.cn', '13800000001', 'admin', 'BUSINESS_ADMIN', '业务管理部', '业务管理员', '男', '业务管理员', 1, 3, 'system', '业务管理员'),
('doctor', 'doctor', '医生管理员', 'doctor@insurance.gov.cn', '13800000002', 'doctor', 'DOCTOR_ADMIN', '医疗服务部', '医生管理员', '男', '主任医师', 1, 4, 'system', '医生管理员'),
('finance', 'finance', '财务管理员', 'finance@insurance.gov.cn', '13800000003', 'finance', 'FINANCE_ADMIN', '财务管理部', '财务管理员', '女', '财务管理员', 1, 5, 'system', '财务管理员');
